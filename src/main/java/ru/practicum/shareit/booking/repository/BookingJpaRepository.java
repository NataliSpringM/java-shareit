...
public interface BookingJpaRepository extends JpaRepository<Booking, Long> {
     ...
     * @return list of bookings of a specific booker, sorting by start in descending order or empty list
     */
    List<Booking> findAllByBookerIdAndStatusInOrderByStartDesc(Long bookerId, List<BookingStatus> notApprovedStatus);
     ...
     * @return list of bookings of a specific booker, sorting by start in descending order or empty list
     */
    List<Booking> findAllByBookerIdAndStatusOrderByStartDesc(Long bookerId, BookingStatus waiting);
     ...
     */
    Optional<Booking> findFirstByItemIdAndStatusAndStartIsBeforeOrStartEqualsOrderByEndDesc(Long itemId, BookingStatus status,
