...
public interface BookingService {
     ...
     */
    List<BookingOutDto> getListByOwner(Long ownerId, String state, Integer from, Integer size);
     ...
     */
    List<BookingOutDto> getListByBooker(Long bookerId, String state, Integer from, Integer size);
}
