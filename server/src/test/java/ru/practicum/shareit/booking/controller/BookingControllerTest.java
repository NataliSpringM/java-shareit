...
public class BookingControllerTest {
    ...
    public void getListByOwner_WhenParametersAreValid_IsStatusOk_AndInvokeService() {
        ...
        // mock service answer
        when(bookingService.getListByOwner(userId, BookingState.ALL, 0, 10)).thenReturn(bookings);
        ...
        // verify invokes
        verify(bookingService).getListByOwner(userId, BookingState.ALL, paramFromValue, paramSizeValue);
    ...
    public void getListByBooker_WhenParametersAreValid_IsStatusOk_AndInvokeService() {
        ...
        //mock service answer
        when(bookingService.getListByBooker(userId, BookingState.ALL, 0, 10)).thenReturn(bookings);
        ...
        verify(bookingService).getListByBooker(userId, BookingState.ALL, paramFromValue, paramSizeValue);
        assertEquals(result, expectedBookingsListString);
    }
